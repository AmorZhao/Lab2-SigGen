...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__0(Vsigdelay___024root* vlSelf) {
    ...
    SData/*8:0*/ __Vdlyvdim0__sigdelay__DOT__MicSignal__DOT__ram_array__v0;
    CData/*7:0*/ __Vdlyvval__sigdelay__DOT__MicSignal__DOT__ram_array__v0;
    CData/*0:0*/ __Vdlyvset__sigdelay__DOT__MicSignal__DOT__ram_array__v0;
    // Body
    __Vdly__sigdelay__DOT__address = vlSelf->sigdelay__DOT__address;
    __Vdlyvset__sigdelay__DOT__MicSignal__DOT__ram_array__v0 = 0U;
    __Vdly__sigdelay__DOT__address = ((IData)(vlSelf->rst)
                                       ? 0U : (0x1ffU 
                                               & ((IData)(1U) 
                                                  + (IData)(vlSelf->sigdelay__DOT__address))));
    if (vlSelf->rd) {
        vlSelf->delayed_signal = vlSelf->sigdelay__DOT__MicSignal__DOT__ram_array
            [vlSelf->sigdelay__DOT__address];
    }
    if (vlSelf->wr) {
        __Vdlyvval__sigdelay__DOT__MicSignal__DOT__ram_array__v0 
            = vlSelf->mic_signal;
        __Vdlyvset__sigdelay__DOT__MicSignal__DOT__ram_array__v0 = 1U;
        __Vdlyvdim0__sigdelay__DOT__MicSignal__DOT__ram_array__v0 
            = (0x1ffU & ((IData)(vlSelf->sigdelay__DOT__address) 
                         + (IData)(vlSelf->offset)));
    }
    vlSelf->sigdelay__DOT__address = __Vdly__sigdelay__DOT__address;
    if (__Vdlyvset__sigdelay__DOT__MicSignal__DOT__ram_array__v0) {
        vlSelf->sigdelay__DOT__MicSignal__DOT__ram_array[__Vdlyvdim0__sigdelay__DOT__MicSignal__DOT__ram_array__v0] 
            = __Vdlyvval__sigdelay__DOT__MicSignal__DOT__ram_array__v0;
    }
}
